...
const Categorize = () => {
    ...
    const input = <div className='w-100 bg-gray-200 m-2 p-2'>
    ...
    const catQ = () => {
        for (let i = 1; i <= catCount; i++) {
            setCategoriesArr(old => [...old, input]);
        }
    }
    useEffect(() => {
        catQ();
        ...
        <div>
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Categorize</h2>
                    {/* <form action="#"> */}
                    ...
                    {/* <button
                        onClick={catQ}
                        type="submit" class="inline-flex items-center px-5 py-2 mt-4 sm:mt-6 text-sm font-medium text-center text-blue bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
                        Add product
                    </button> */}
                    {/* </form> */}
                </div>
